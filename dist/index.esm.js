...
function Label(_a) {
    ...
    return (jsxs("div", __assign({ className: modules_536e8d56.container }, { children: [jsx("span", __assign({ className: modules_536e8d56.title }, { children: text })), children] })));
}

export { Carousel, Label, List, fetchMedium };
